...
class lstm(nn.Module):
    def __init__(self, opt):
        ...
        self.match = nn.Sequential(
            nn.Linear(self.hidden_dim, self.source_dim),
    ...
    def forward(self, batch):
        ...
        lstm_out_ = [self.match(i) for i in lstm_out.view(num_frames,-1,self.hidden_dim)]

        return lstm_out_train, lstm_out_test, lstm_out_, lstm_out