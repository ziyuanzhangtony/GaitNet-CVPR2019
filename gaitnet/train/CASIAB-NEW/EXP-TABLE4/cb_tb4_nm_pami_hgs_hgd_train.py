...
from utils.modules.modules_cb_pami_tab4 import *
...
train_structure = {
    'clip1': (list(range(0,180+1,18)),
              {
                  # 'cl':list(range(1, 2 + 1)),
               'nm':list(range(1, 6 + 1))}
              ),
    'clip2': (list(range(0,180+1,18)),
          {
              # 'cl':list(range(1, 2 + 1)),
           'nm':list(range(1, 6 + 1))}
          ),
...
test_structure = {
    ...
    'probe': (list(range(0,180+1,18)), ['nm'], [5,6]),
}
...
with torch.no_grad():
    scores_cmc_cl_test, _ = eval_cmc_two(test_eval[0], test_eval[1], [netE, lstm], opt, test_structure['gallery'][0],
                                         test_structure['probe'][0], False, 4, 2)
...
#             scores_cmc_cl_test, _ = eval_cmc_two(test_eval[0], test_eval[1], [netE, lstm], opt, test_structure['gallery'][0], test_structure['probe'][0], False,4,2)
