...
test_analogy_row, test_analogy_col = test_data.get_analogy_format(row,col)
...
#             netE.eval()
#             lstm.eval()
#             scores_cmc_cl_train, _ = eval_cmc_two(train_eval[0], train_eval[1],[netE, lstm], opt, test_structure['gallery'][0], test_structure['probe'][0], False)
#             scores_cmc_cl_test, _ = eval_cmc_two(test_eval[0], test_eval[1], [netE, lstm], opt, test_structure['gallery'][0], test_structure['probe'][0], False)
