...
parser.add_argument('--signature', default='old_code-new_data-padtopdown-newdataloader')
...
while True:
    ...
    losses1 = train_main(im_nm, im_cl,im_nm,lb)
    write_tfboard(losses1,itr,name='EDLoss')

    losses3 = train_lstm(im_nm,im_cl,im_nm,lb)
