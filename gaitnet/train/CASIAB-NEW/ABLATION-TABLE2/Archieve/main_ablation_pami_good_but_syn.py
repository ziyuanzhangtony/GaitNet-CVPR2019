...
def train_main(Xa, Xb, l, X2):
    ...
    for i in range(0, len(Xa)):
        ...
        hgd_a.append(hg_a1[1])
        hgd_b.append(hg_b1[1])
        # ------------------------------------------------------------------
        # sta gait sim loss
        hgs_loss += mse_loss(hg_a0[0], hg_a1[0])
        hgs_loss += mse_loss(hg_a0[0], hg_b1[0])
        hgs_loss += cse_loss(netE.fgs_clf(hg_a0[0]),l)
