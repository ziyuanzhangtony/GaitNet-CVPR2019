...
parser.add_argument('--siter', type=int, default=1000, help='number of itr to start with')
...
while True:
    ...
    if itr % 5 == 0:
        ...
        netE.eval()
        lstm.eval()
        scores = eval_lstm_roc(test_eval[0], test_eval[1],test_eval[2])
        write_tfboard(scores, itr, name='test_accu_rank1_cl')
