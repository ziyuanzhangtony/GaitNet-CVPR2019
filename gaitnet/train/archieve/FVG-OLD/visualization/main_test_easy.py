...
parser.add_argument('--siter', type=int, default=5200, help='number of itr to start with')
...
time_now = '2018-11-15 04:05:15.681656'
...
def eval_lstm_roc(glr, prb, gt, n_test  = 90):
    ...
    t = time.time()-st
    print(len(hp_glr)*n_test,t,t/len(hp_glr)*n_test)
