...
class FVG(object):
    ...
    def get_eval_data_all(self,
        ...
        for i, id in enumerate(subjects):
            ...
            if id in list(range(1, 147 + 1)):
                test_data_glr.append(read_frames_('SEG-S1', id, gallery))
                ...
                test_data_glr.append(read_frames_('SEG-S2', id, gallery))
                for j in session1_probe:
...
parser.add_argument('--siter', type=int, default=72000, help='number of itr to start with')
parser.add_argument('--lr', default=0.00001, type=float, help='learning rate')
parser.add_argument('--data_root',
                    default='/home/tony/Research/FVG-SEG-PNG',
...
time_now = '2019-03-11 23:59:13.404123'
