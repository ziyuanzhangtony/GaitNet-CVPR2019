...
parser.add_argument('--siter', type=int, default=4000, help='number of itr to start with')
...
parser.add_argument('--prb_views',type=list, default=[126,144,162,180], help='')

import datetime
# time_now = str(datetime.datetime.now())
time_now = '2018-11-11 00:16:58.652611'
