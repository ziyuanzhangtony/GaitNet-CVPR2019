...
parser.add_argument('--siter', type=int, default=2800, help='number of itr to start with')
...
parser.add_argument('--em_dim', type=int, default=1024, help='size of the pose vector')
parser.add_argument('--ha_dim', type=int, default=768, help='size of the appearance vector')
parser.add_argument('--hg_dim', type=int, default=256, help='size of the gait vector')
...
time_now = "2019-04-20 01:41:30.929545"
